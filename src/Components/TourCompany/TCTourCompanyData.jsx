...
const TourCompanyData = () => {
  ...
  return (
    <>
    <section>
    <div className={t.tourCompanyContainer}>
                    ...
                    >
                      {columns.map((column) => {
                        ...
                        if (column.id === 'actions') {
                          return (
                            <div key={column.id} align={column.align} className={t.actoin_btns}>
  <div className={t.action_btn_box}>
    <IconButton
                                    className={t.editButton} // Add this class for the blue color
                                    color="primary"
  ...
  <div className={t.action_btn_box}>
    <IconButton
          className={t.deleteButton} // Add this class for the red color
          color="secondary"
