...
import t from './TCTourCompanyData.module.css';

const columns = [
  { id: 'id', label: 'Id', minWidth: 50 },
  { id: 'name', label: 'Tour Name', minWidth: 170 },
...
const TCTourData = () => {
  ...
  return (
    <>
    <section>
    <div className={t.TableHeadtourCompanyContainer}>
      <h2>Tours</h2>
                    ...
                    >
                      {columns.map((column) => {
                        ...
                        if (column.id === 'actions') {
                          return (
                            <div key={column.id} align={column.align} className={t.TableHeadactoin_btns}>
  <div className={t.TableHeadaction_btn_box}>
  <IconButton
                                    className={t.TableHeadeditButton} // Add this class for the blue color
                                    color="primary"
  ...
  <div className={t.TableHeadaction_btn_box}>
  <IconButton
          className={t.TableHeaddeleteButton}// Add this class for the red color
          color="secondary"
