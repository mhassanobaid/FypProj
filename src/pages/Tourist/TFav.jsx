...
<SlideShowContainer>
  ...
  <a key={index} onClick={() => handleAnchorClick(tour.tourid)} style={{ textDecoration: 'none' }}>
    <div class={TFCSS.insiDv}><TourCardd>
      {/* Render tour details here */}
      <img src={tour.image_url} alt="Tour" style={{width:'100%',height:'200px',marginTop:'35px',marginLeft:'5px'}} />
      <div>
        ...
        <p><div style={dvSt}>Tourists Allowed:</div>&ensp;&nbsp;<div class={TFCSS.tct}>{tour.number_of_persons}</div></p>
        <p><div style={dvSt}>Departure Date:</div>&ensp;&nbsp;<div class={TFCSS.tct}>{tour.departure_date}</div></p>
  ...
  <div style={{ display: 'flex', alignItems: 'center', marginLeft: '300px',border:'1px solid grey',width:'700px' }}> {/* Encapsulate the tour card content */}
    <img src={tour.image_url} alt="Tour" style={{width:'300px',height:'200px',marginTop:'35px',marginLeft:'5px'}} />
